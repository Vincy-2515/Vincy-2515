...
#menubar setting----------------------------------------------------------------------
        ...
        settings_dropdown.add_command(label="Temi", state= DISABLED)
        #tipi di temi---------------------------------------------------
        settings_dropdown.add_command(label="Dark",
                                      command=self.cambio_tema_DARK)
        settings_dropdown.add_command(label="Light",
                                      command=self.show_relase_notes)

        settings_dropdown.add_separator()
        settings_dropdown.add_command(label="Font", state= DISABLED)

#aggiunta vari menu a cascata---------------------------------------------------------
        menubar.add_cascade(label="File", menu=file_dropdown)
        menubar.add_cascade(label="About", menu=about_dropdown)
        menubar.add_cascade(label="Impostazioni", menu=settings_dropdown)
    ...
    def cambio_tema_DARK(self):
        file = open("esempiol.txt", "w")
        file.write("background='black',fg=white")
        file.close()
